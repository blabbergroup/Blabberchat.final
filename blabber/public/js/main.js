...
myVideo.muted = true
//UNDEFINED IS UUID SO IT NEEDS TO CREATE A NEW ONE WHEN USER REGISTERS AND THEN STORES UUID ON FIRST CONNECTION.
//THEN IT NEEDS TO DO DATA VALIDATION.

//IDEA:
//IF USERNAME MATCHES ONE IN DATA BASE THEN SEND UUIP TO THAT ROW AND CALL UUID FROM THAT ROW EACH TIME.
...
socket.on('roomNotValid', () => {
    alert("Room does not exist, please only select either General, Chill or Gaming.");
    window.history.back();
});
...
navigator.mediaDevices.getUserMedia(
    ...
    */
    ...
    socket.on('user-connected', userId => {
        ...
        console.log(userId)
        // make sure peer.on('call') has been executed first
...
//var client_id = sql select client_id from accounts that match the cookie in browser,}
